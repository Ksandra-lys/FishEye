export function createInfoPhotographer(objectOfPhotographer) {
    const portfolioContainer = document.querySelector(".header_infophotographer");
...
//# sourceMappingURL=createInfoPhotographer.mjs.map